...
enum ept_event_type
{
	...
	EPT_EVENT_KVM_PAGE_FAULT = 13,
	EPT_EVENT_KVM_MMU_SPLIT_HUGE_PAGE = 14,
	EPT_EVENT_MARK_MMIO_SPTE = 15,
	EPT_EVENT_SYS_ENTER_MADVISE = 16,
	EPT_EVENT_SYS_EXIT_MADVISE = 17,
	EPT_EVENT_SYS_ENTER_MMAP = 18,
	EPT_EVENT_SYS_EXIT_MMAP = 19,
};
