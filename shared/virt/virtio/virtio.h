...
#define VIRTIO_GUEST_IDT_GPA 0x1000
#define VIRTIO_GUEST_IDT_SIZE 0x1000
#define VIRTIO_GUEST_COMPLETION_GPA 0x1ffc
...
#define VIRTIO_IOEVENTFD_DESC_INDEX 5
#define VIRTIO_TOTAL_REQUEST_COUNT 6
...
/* Phase D uses one pre-wired legacy PIC input so the irqfd mechanism remains visible. */
#define VIRTIO_IRQ_GSI 5
#define VIRTIO_PIC_MASTER_VECTOR_BASE 0x20
#define VIRTIO_PIC_SLAVE_VECTOR_BASE 0x28
#define VIRTIO_IRQ_VECTOR (VIRTIO_PIC_MASTER_VECTOR_BASE + VIRTIO_IRQ_GSI)
