...
scp -p "${ssh_opts[@]}" "$SCRIPT_DIR/vmm.c" "$SCRIPT_DIR/guest.S" "$SCRIPT_DIR/observer.c" "$SCRIPT_DIR/io.bpf.c" "$SCRIPT_DIR/io_event.h" "$SCRIPT_DIR/device.h" "$SCRIPT_DIR/Makefile" "$TARGET:$IO_DIR/"
