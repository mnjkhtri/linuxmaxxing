...
def build(name):
    ...
    if cfg["environment"] == "guest":
        # The distro bpftool wrapper follows the running host kernel. Guest
        # CO-RE artifacts must be generated by the tool built from this exact
        # pinned kernel source instead.
